...
use Classes\Core\PostTypes as PostTypeFactory;

$ptype_factory = new PostTypeFactory();

$ptype_factory->register_new_post_types(
  array(
    array(
      'plural_name' => 'ptypes1',
...
class PostTypes{
  ...
  public function register_new_post_types($post_types = null){
